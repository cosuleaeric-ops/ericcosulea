...
<head>
  ...
  <style>
    ...
    .btn { background: #d7c2a5; color: #3f2d1b; border: 1px solid rgba(143, 111, 74, 0.18); border-radius: 999px; padding: 8px 14px; font-size: 16px; font-family: "Crimson Pro", serif; font-weight: 600; letter-spacing: 0.01em; text-decoration: none; text-transform: lowercase; }
