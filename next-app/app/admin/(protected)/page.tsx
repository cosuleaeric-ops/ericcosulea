...
const TOOLS: { href: string; name: string; icon: LucideIcon; chip: string }[] = [
  ...
  { href: "/admin/brain", name: "brain", icon: Brain, chip: "bg-[#ecf7f1] text-[#1d9e75]" },
      ...
      <div className="mb-7 grid grid-cols-1 gap-2.5 sm:grid-cols-2 md:grid-cols-3">
        {TOOLS.map((t) => (
          <Link key={t.href} href={t.href}>
            <Card className="flex-row items-center gap-3 px-4 py-4.5 transition-colors duration-150 hover:border-ring hover:bg-secondary">
