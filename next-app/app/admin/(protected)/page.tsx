    ...
    <div className="mx-auto max-w-[700px] px-9 py-8">
      ...
      <div className="mb-7 grid grid-cols-1 gap-2.5 sm:grid-cols-2 md:grid-cols-3">
        {TOOLS.map((t) => (
          <Link key={t.href} href={t.href}>
            <Card className="flex-row items-center gap-3 px-4 py-4.5 transition-all duration-150 hover:border-ring hover:shadow-lg">
      ...
      <div className="grid grid-cols-1 gap-2.5 md:grid-cols-3">
        <Link href="/admin/posts">
          <Card className="h-full gap-0 px-5 py-4.5 transition-all duration-150 hover:border-ring hover:shadow-lg">
